...
export const P = {
  ...
  dispatchChatDir:   path.join(ROOT, 'runtime', 'dispatch-chat'),
  dispatchIssueDir:  path.join(ROOT, 'runtime', 'dispatch-issue'),
  dispatchChatLog:   path.join(ROOT, 'runtime', 'dispatch-chat.log'),
  dispatchIssueLog:  path.join(ROOT, 'runtime', 'dispatch-issue.log'),
